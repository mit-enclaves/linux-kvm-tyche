...
#define KVM_FLAGS_MEM_ACCESS_RIGHTS_MASK (0b111111U << KVM_FLAGS_MEM_ACCESS_RIGHTS_IDX)
/* Begining of the segment type in the KVM flags */
#define KVM_FLAGS_SEGMENT_TYPE_IDX (KVM_FLAGS_MEM_ACCESS_RIGHTS_IDX + KVM_FLAGS_MEM_ACCESS_RIGHTS_SIZE)
/* The number of bits used to encode the segment type in kvm flags */
#define KVM_FLAGS_SEGMENT_TYPE_SIZE (2)
/* The mask for the segment type in kvm flags */
#define KVM_FLAGS_SEGMENT_TYPE_MASK (0b11U << KVM_FLAGS_SEGMENT_TYPE_IDX)
/* Marker to signal encoding is present*/
#define KVM_FLAGS_ENCODING_PRESENT (0b1U << (KVM_FLAGS_SEGMENT_TYPE_IDX + KVM_FLAGS_SEGMENT_TYPE_SIZE))
